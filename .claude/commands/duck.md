...
<writes*to>
**Research Output**: Create `documentation/planning/research/[timestamp]*[topic].md` containing:
...
**Create Research File**: After analysis, create `documentation/planning/research/[timestamp]*[topic].md`with complete findings for use by`/plan`and`/implement` commands.
